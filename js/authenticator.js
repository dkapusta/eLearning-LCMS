window.authenticator = function() {
        ...
        try {
            $.ajax({
                ...
                success: function(data, textStatus) {
                    value = data;
                    self.updateField(id, value);
                    // console.log('Phrase for ' + id + ': ' + data);
                },
        ...
        try {
            $.ajax({
                ...
                data: {
                    ...
                    userId: self.options['userId'],
                    courseId: self.options['courseId'],
                    testId: self.options['testId']
                },
                success: function(data, textStatus) {
                    console.log(data);
                    $("#applyForTestModal").modal('hide');
                    elearn_start_test(self.options['courseId'], self.options['testId'], Number(data));
                },
                error: function(jqXHR, textStatus, errorThrown) {
    ...
    options['testId']   = document.querySelector('#testId').value;
